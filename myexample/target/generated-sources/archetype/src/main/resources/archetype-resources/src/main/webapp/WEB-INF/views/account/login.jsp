...
<body>
	<form id="loginForm" action="${symbol_dollar}{ctx}/login" method="post" class="form-horizontal" style="margin-top:60px">
	<%
	...
	<script>
		${symbol_dollar}(document).ready(function() {
			...
			//${symbol_dollar}("${symbol_pound}login-tab").addClass("active");
		});
	</script>
</body>
</html>
