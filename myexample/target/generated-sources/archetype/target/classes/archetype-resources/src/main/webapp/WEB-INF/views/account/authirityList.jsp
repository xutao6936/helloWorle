...
<body>
	...
	<div class="row" style="margin-top:60px">
		<div class="span4 offset7">
			<form class="form-search" action="${symbol_dollar}{ctx }/authirity/List" method="post">
			
				<label>权限名：</label> 
				<form class="navbar-search pull-left">
				  	<input type="text" class="search-query input-medium" placeholder="Search" name="search_LIKE_authName"  value="${symbol_dollar}{param.search_LIKE_authName}"/>
				</form>
		    </form>
	    </div>
	</div> 
	<table id="contentTable" class="table table-striped table-bordered table-condensed topForm">
		...
		<c:forEach items="${symbol_dollar}{objects.content}" var="entity">
			<tr>
				<td>
					${symbol_dollar}{entity.authCode }
				</td>
				<td>
					${symbol_dollar}{entity.authName }
				</td>
				<td><a href="${symbol_dollar}{ctx}/authirity/delete/${symbol_dollar}{entity.id}">删除</a></td>
			</tr>
		</c:forEach>
		</tbody>
